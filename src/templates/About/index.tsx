...
const owners: IAboutPeopleProps[] = [
  ...
  },
  {
    name: '김영훈',
    desc:
      '조금이라도 많은 사람들이 Snack 안에서 재미를 느낄 수 있었으면 좋겠습니다. 더 좋은 사용자 경험을 주는 Snack News가 되길 바라며 !',
  },
  {
    name: '권영재',
    desc:
      'Snack이 많은 사람들에게 좋은 가치를 전달해 주기 위해 노력하는 Back-end 개발자입니다. 🙂많이 사랑해주세요 ~!',
  },
  {
    name: '허승',
    desc:
      '모두가 기술에 대해 알게되어 더 나은 세상을 위해 토론하는 세상을 꿈꿉니다. 그런 날이 올때까지 좋은 제품을 만들고싶은 UX디자이너입니다.',
  },
];
    ...
    items={[
      ...
      },
      {
        el: (
          <BothMarginWrapper>
            <Paragraph>
              이 프로젝트를 통해 다소 지루했던 출퇴근길이 조금 더 유익해지는 시간이 되었으면
              좋겠습니다.
            </Paragraph>
          </BothMarginWrapper>
        ),
